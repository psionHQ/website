...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: "What makes PSIONHQ different from standard cloud AI providers?",
    answer:
      "Standard cloud providers run your AI workloads on shared infrastructure with full visibility into your prompts and outputs. PSIONHQ runs inference inside Trusted Execution Environments — hardware-isolated enclaves that are mathematically unreadable, even to our own operators. Your data never exists in plaintext outside your control boundary.",
  },
  {
    question: "Does PSIONHQ ever have access to my data or model outputs?",
    answer:
      "No. PSIONHQ is architected so that we structurally cannot access your data. Vault contents are encrypted client-side before transmission. AI prompts are decrypted only inside the hardware enclave and never written to disk. Even in the event of a full server compromise, your plaintext remains inaccessible.",
  },
  {
    question: "What is a Trusted Execution Environment (TEE)?",
    answer:
      "A TEE is a hardware-isolated region of a processor that executes code in an environment where neither the operating system, the hypervisor, nor the cloud operator can inspect or tamper with the workload. PSIONHQ uses Intel TDX, AMD SEV-SNP, and ARM CCA to provide hardware attestation — cryptographic proof that your code is running unmodified on genuine secure hardware.",
  },
  {
    question: "Is PSIONHQ compliant with GDPR, HIPAA, and SOC 2?",
    answer:
      "PSIONHQ is designed to support compliance with GDPR, HIPAA, and SOC 2 Type II requirements. Our zero-knowledge architecture means we hold no personal data in recoverable form. We provide data processing agreements, audit logging, and dedicated infrastructure options for regulated industries. Enterprise customers receive a full compliance documentation pack.",
  },
  {
    question: "How quickly can I integrate PSIONHQ into an existing application?",
    answer:
  ...
  {
    question: "Can I deploy PSIONHQ in my own cloud account or on-premises?",
    answer:
      "Yes. Enterprise plans support deployment into your own AWS, GCP, or Azure account using our Helm chart or Terraform modules. On-premises deployment is available for air-gapped environments. In both cases you retain full control of the encryption keys and the infrastructure, and PSIONHQ never has network access to your deployment.",
  },
];
